...
import { createAppointmentController, getAppointmentsController, updateAppointmentStatusController, cancelAppointmentController, rescheduleAppointmentController } from "./appointment.controller.js";
...
router.post("/", requireAuth, validate(createAppointmentSchema), createAppointmentController);
