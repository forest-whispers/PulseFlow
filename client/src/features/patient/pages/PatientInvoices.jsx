...
import { Calendar, User, Receipt, Stethoscope, RefreshCw, AlertCircle, Eye, IndianRupee } from "lucide-react"
      ...
      <div className="min-h-[50vh] flex flex-col items-center justify-center text-center p-6 space-y-4 max-w-md mx-auto animate-fade-in">
        ...
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground text-sm leading-relaxed">
            {error?.response?.data?.message || error?.message || "We encountered an issue retrieving your billing history. Please try again."}
          </p>
        </div>
  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto p-4 sm:p-6">
      <div className="flex flex-col gap-1">
        <h2 className="text-xl sm:text-2xl font-extrabold text-foreground">Billing Statements</h2>
        <p className="text-xs text-muted-foreground">
          View all payment receipts, Stripe cards, and cash invoice logs generated by your doctor.
        </p>
      </div>
      ...
      {invoices.length === 0 ? (
        ...
        <Card className="border border-dashed border-border/40 shadow-2xs bg-card p-12 text-center rounded-2xl animate-fade-in">
          ...
          <h3 className="text-base font-bold text-foreground mb-1.5">No Invoices</h3>
          <p className="text-xs text-muted-foreground max-w-xs mx-auto leading-relaxed">
            You do not have any billing sheets or invoices generated in the system yet.
          </p>
        </Card>
      ) : (
        // Grid Listing
              ...
              return (
                ...
                >
                  ...
                  <CardContent className="p-5 space-y-4 flex-1">
                    ...
                    <div className="flex justify-between items-start gap-4">
                      ...
                      <div className="text-right">
                        ...
                        <p className="text-xs font-bold text-foreground truncate mt-0.5">
                          {invoice.doctor?.name?.startsWith("Dr.") ? invoice.doctor.name : `Dr. ${invoice.doctor?.name}`}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4 pt-2.5 border-t border-border/5 text-xs">
                      ...
                      <div>
                        ...
                        <p className="font-semibold text-foreground uppercase mt-0.5">
                  ...
                  <CardFooter className="p-5 pt-3 pb-4 border-t border-border/10 bg-muted/10 flex justify-end">
                    <Link to={window.location.pathname.startsWith("/doctor") ? `/doctor/invoices/${invoice._id}` : `/patient/invoices/${invoice._id}`}>
